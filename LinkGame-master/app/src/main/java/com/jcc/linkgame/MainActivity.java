...
//    new SoundPool(2, AudioManager.STREAM_SYSTEM, 8);
    ...
    public void onCreatecontextview(ContextMenu menu,View source,
                                ContextMenu.ContextMenuInfo menuInfo)
    {
    menu.add(0,MENU1,0,"简单难度");
    menu.add(0,MENU2,0,"中等难度");
    menu.add(0,MENU3,0,"困难难度");
    menu.add(0,MENU4,0,"关于游戏");//4个单选菜单项
    menu.setGroupCheckable(0,true,true);
    menu.setHeaderIcon(R.drawable.menu);
    menu.setHeaderTitle("难度设置");
    }
