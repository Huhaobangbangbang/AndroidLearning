...
public abstract class AbstractBoard2 {
    ...
    public Piece[][] create(GameConf config){
        ...
        List<PieceImage> playImages = ImageUtil2.getPlayImages(config.getContext(), notNullPieces.size());
